...
-- Copiloto de management (resumen semanal por equipo)
CREATE TABLE management_recommendations (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    team_id INTEGER NOT NULL REFERENCES teams(id) ON DELETE CASCADE,
...
CREATE INDEX idx_management_recommendations_team ON management_recommendations(team_id);

-- Copiloto de management (recomendación por persona)
CREATE TABLE person_management_recommendations (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    team_id INTEGER NOT NULL REFERENCES teams(id) ON DELETE CASCADE,
...
CREATE INDEX idx_person_management_rec_team ON person_management_recommendations(team_id);
CREATE INDEX idx_person_management_rec_person ON person_management_recommendations(person_id);
