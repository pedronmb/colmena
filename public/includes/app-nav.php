...
<nav class="app-nav" aria-label="Secciones">
    ...
    <a href="devops.php" class="app-nav__link<?= $activeNav === 'devops' ? ' app-nav__link--active' : '' ?>"<?= $activeNav === 'devops' ? ' aria-current="page"' : '' ?>>DevOps</a>
    <a href="invgate.php" class="app-nav__link<?= $activeNav === 'invgate' ? ' app-nav__link--active' : '' ?>"<?= $activeNav === 'invgate' ? ' aria-current="page"' : '' ?>>InvGate</a>
    ...
    <a href="scratchpad.php" class="app-nav__link<?= $activeNav === 'scratchpad' ? ' app-nav__link--active' : '' ?>"<?= $activeNav === 'scratchpad' ? ' aria-current="page"' : '' ?>>Bloc personal</a>
</nav>
